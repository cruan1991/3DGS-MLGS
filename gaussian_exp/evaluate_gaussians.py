...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Gaussian Splatting models by rendering and computing PSNR')
    ...
    parser.add_argument('--images-dir', 
                        default='/shared/user59/workspace/cihan/3dgs_Vincent/my_3dgs/data/mipnerf360/360/tandt_db/tandt/truck/images',
                        help='Path to the directory containing ground truth images (default: truck dataset)')
    parser.add_argument('--output-dir', default='renders/eval_output', help='Directory to save rendered images and metrics')
